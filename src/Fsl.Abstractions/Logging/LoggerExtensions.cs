...
namespace Fsl.Abstractions.Logging
{
	public static class LoggerExtensions
	{
		...
		{
			logger.Log(nameof(T),LogLevel.Information, null, message, args);
		}
		...
		public static void Error(this ILogger logger, string category, Exception ex, string message, params object[] args)
		{
